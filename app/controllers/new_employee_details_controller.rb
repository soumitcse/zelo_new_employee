...
NewsletterMailer.weekly("hr@zelo.in", "New Employee Onboard" , "Employee Id" , @employee_details.zolo_id , "Employee Name" , @employee_details.name , "Employee Detail" , "https://welcome-to-zelo.herokuapp.com/new_employee_details/#{@employee_details.id}" ).deliver
